...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{lfcdist.jpeg}
...
<<echo=TRUE,eval=FALSE>>=
# download pre calculated estimated negative binomial parameters
githubURL <- "https://github.com/bvieth/powsimRData/raw/master/data-raw/kolodziejczk_param.rda"
download.file(url = githubURL, destfile= "kolodziejczk_param.rda", method = "wget")
load('kolodziejczk_param.rda')
TwoiLIF.params <- kolodziejczk_param
...
# exemplatory simDE
githubURL <- "https://github.com/bvieth/powsimRData/raw/master/data-raw/kolodziejczk_simDE.rda"
download.file(url = githubURL, destfile= "kolodziejczk_simDE.rda", method = "wget")
load('kolodziejczk_simDE.rda')
...
% \caption{Power assessment for Kolodziejczyk simulation.}
% \label{fig:power}
% \end{figure}
...
<<echo=TRUE,eval=FALSE>>=
TwoiLIF.distfit = evaluateDist(cnts = Kolodziejczyk.cnts,
                             RNAseq = 'singlecell',
                             ncores = 1,
                             nsims = 1,
                             frac.genes = 1,
...
\Rfunction{PowSim} is a wrapper including estimation, simulation and evaluation. Please consult the detailed description of \Rfunction{PowSim} help page.
<<echo=T, eval=F>>=
